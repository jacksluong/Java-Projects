...
import JavaFX.FeedbackManager;
import JavaFX.PopupPrompt;
import Circus.Employee;
import Circus.Version1.*;
...
public class CircusV_client extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        sparse.setOnMouseClicked(e -> pathname.setValue("src/Circus/Employees Lite.txt"));
        crowded.setOnMouseClicked(e -> pathname.setValue("src/Circus/Employees.txt"));
